...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-k8pjewy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-k8pjewy.containers.anotherwebservice.com/
...
```
git clone git@github.com:IlllaP/container-k8pjewy.git
cd container-k8pjewy
```
...
```
docker attach container-k8pjewy
```
